...
function AnimatedTestimonials() {
  ...
  return (
    <div className="bg-gradient-to-b from-background dark:from-black via-purple-300 dark:to-black to-background">
      ...
      <motion.div
        ...
        className="px-8"
      >
        <AnimatedTestimonials_ testimonials={testimonials} />
      </motion.div>
      <div ref={ref}></div>
    </div>
  );
}
const AnimatedTestimonials_ = ({
  testimonials,
  autoplay = false,
}: {
